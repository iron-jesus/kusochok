...
@Service
public class VinlandSagaScrapperService implements IScrapper {
    @Override
    public List<ScrapChapterLink> scrapChapterLinks() throws LinkAccessException {
        try {
            Document doc = Jsoup.connect("https://read-vinlandsaga.com/").get();
            ...
            throw new LinkAccessException("https://read-vinlandsaga.com/", e);
        }
    }
    ...
    public String getTitleName() {
        return TitleName.VINLAND_SAGA.getName();
    }
}
